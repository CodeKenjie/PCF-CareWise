...
<main id="dashboard">
    <section>
        <div class="acrylic-bg mini">
            <h3 id="activePatients"></h3>
            <h4>Active patients</h4>
        </div>
        <div class="acrylic-bg mini">
            <h3 id="inactivePatients"></h3>
    ...
    <div class="sub-sec main-panel">
        ...
        <section class="acrylic-bg" style="flex: 1 1 0; min-height:10rem">
            <div style="display: flex; justify-content: space-between; align-items: center;">
        ...
        <section class="acrylic-bg" style="flex-direction: row; flex-wrap: wrap;">
            <div style="flex: 1 1 0; display:flex; align-items:center; justify-content:center">
                <div class="rel donut-chart">
                    ...
                    <span class="abs ctr-text">
                        <h2 id="totalItems" style="font-size: var(--bigger);">0</h2>
                        <h5 id="label" style="font-size: var(--super-small); font-weight: var(--bold); opacity: 50%">Items</h5>
                    </span>
                </div>
                <span class="info">
                    <p>High Stocks</p>
            ...
            <div style="flex: 1 1 0; display:flex; align-items:center; justify-content: center">
                <div class="rel donut-chart">
                    ...
                    <span class="abs ctr-text">
                        <h1 id="exp-status" style="font-size: var(--bigger);">0</h1>
                        <h3 id="explabel"style="font-size: var(--super-small); font-weight: var(--bold); opacity: 50%">Items</h3>
                    </span>
                </div>
                <span class="info">
                    <p>Good Expiration</p>
...
<template id="lowItemCard">
    <li>
        ...
        <span class="rel fc" style="flex: 1 1 0; height: 100%; justify-content: center">
            <h6 class="quantities abs itemQuant"></h6>
            <h3 class="itemStatus f aj-c" style="cursor: pointer;"></h3>
        </span>
        <span class="f aj-c" style="flex: 1 1 0; gap: 0.5em">
