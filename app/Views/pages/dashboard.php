    ...
    <div class="sub-sec">
        <section class="acrylic-bg">
            <div style="display: flex; justify-content: space-between; align-items: center">
                ...
                <a id="registerPatientBtn" class="btn-borderless btn-accent" style="padding: 0.5em; color: var(--alt-font-color);background: var(--button-color)">
        ...
        <section class="acrylic-bg" style="flex: 1 1 0">
            <div style="display: flex; justify-content: space-between; align-items: center">
                ...
                <a class="btn-borderless btn-accent" style="padding: 0.5em; color: var(--alt-font-color);background: var(--button-color)" href="/schedule">
    ...
    <section class="acrylic-bg">
        <div>
            <div class="rel donut-chart">
                ...
                <span class="abs ctr-text">
                    <h1 class="lrg-h" id="totalItems"></h1>
        ...
        <div>
            <div class="rel donut-chart">
                ...
                <span class="abs ctr-text">
                    <h1 class="lrg-h" id="exp-status"></h1>
...
<template id="lowItemCard">
    <li>
        ...
        <button class="adjustBtn btn-borderless btn-accent">
        ...
        <button class="deleteBtn btn-borderless btn-critical">
