...
<main id="medicines">
    <section class="actions acrylic-bg">
        <button id="addMedsBtn" class="addBtn btn-accent" style="display: <?= ($isEditor ?? false) ? 'flex' : 'none'?>;">
...
<div id="medsPreview" class="popup">
    <section class="preview">
        ...
        <div>
            ...
            <span>
                <label for="mMinQuant"><strong>Min Quantity:</strong></label>
                <h3 id="mMinQuant"></h3>
            </span>
        </div>
        <div>
...
<div id="editMeds" class="popup">
    <form id="editMedsForm" class="form-ui" action="/medicines/edit" method="post">
        ...
        <div class="part p-sm">
            <span>
                <input id="updateDosage" type="text" placeholder="N/A" required>
                <label for="">Dosage</label>
            </span>
            <span>
                <input id="updateForm" type="text" placeholder="N/A" required>
                <label for="">Form</label>
            </span>
        </div>
        <div class="part">
...
<template id="medicineCard">
    <li class="rel">
        ...
        <span style="display: grid; gap: 0.5em;">
            ...
            <button class="editBtn btn-highlight" <?= ($isEditor ?? false) ? '' : 'hidden' ?>>
            ...
            <button class="deleteBtn btn-critical" <?= ($isEditor ?? false) ? '' : 'hidden' ?>>
