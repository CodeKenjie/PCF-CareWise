...
<main id="inventory">
    <section class="actions acrylic-bg">
        <button id="addItemBtn" class="addBtn btn-accent" style="display: <?= ($isEditor ?? false) ? 'flex' : 'none' ?>">
    ...
    <li>
        <table>
            <tr>
                ...
                <td style="flex: 0 0 fit-content; gap: 0.5em">
                    <button class="adjustBtn btn-accent" style="color: var(--font-color)" <?= ($isEditor ?? false) ? '' : 'hidden' ?>>
                    ...
                    <button class="editItemBtn btn-highlight" <?= ($isEditor ?? false) ? '' : 'hidden' ?>>
                    ...
                    <button class="deleteItemBtn btn-critical" style="color: var(--font-color)" <?= ($isEditor ?? false) ? '' : 'hidden' ?>>
