...
<div id="itemPreview" class="popup">
    <section class="preview">
        ...
        <span>
            <label for="iQuantity"><strong>Quantity:</strong></label>
            <h3 id="iQuantity"></h3>
        </span>
        <span>
            <label for="iMinQuant"><strong>Minimum Quantity:</strong></label>
            <h3 id="iMinQuant"></h3>
        </span>
        <span>
            <label for="iExpiration"><strong>Expiration Date:</strong></label>
...
<div id="editItem" class="popup">
    <form id="editItemForm" class="form-ui" action="/inventory/edit" method="post">
        ...
        <div class="part p-sm">
            <span>
                <input id="updateQuantity" name="updateQuantity" type="text" required>
                <label>Quantity</label>
            </span>
            <span>
