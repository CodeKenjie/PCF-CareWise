...
<main id="schedule">
    <section id="calendar" class="acrylic-bg main-panel">
        <div id="month">
            ...
            <button id="addSchedBtn" class="btn-square btn-accent hidden" style="background: var(--button-color); color: var(--alt-font-color); border: none" <?= ($isEditor ?? false) ? '' : 'hidden' ?>>
    ...
    <section id="list" class="acrylic-bg main-panel">
        <ul id="collection"></ul>
    </section>
</main>
...
<template id="scheduleCard">
    <li>
        ...
        <div>
            <button class="reSched btn-accent hidden" <?= ($isEditor ?? false) ? '' : 'hidden' ?>>
