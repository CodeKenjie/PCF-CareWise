...
$router->get('/patients/patient/view', 'App\Controllers\PatientsController@get');
$router->post('/patients/patient/register', 'App\Controllers\PatientsController@register');
