...
$router->patch('/me/update/password', 'App\Controllers\UserController@password');
$router->patch('/me/verify', 'App\Controllers\UserController@verify');
$router->get('/me/verification/resend', 'App\Controllers\UserController@resend');
